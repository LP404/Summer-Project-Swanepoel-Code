...
match SubstrateMode:
    ...
    case 2:
            ...
            path1, dirs1, files1 = next(os.walk(os.path.dirname(os.path.realpath('Code.py')) + '\\SubstrateData'))
            path2, dirs2, files2 = next(os.walk(os.path.dirname(os.path.realpath('Code.py')) + '\\SubstrateData\\Single'))
            path3, dirs3, files3 = next(os.walk(os.path.dirname(os.path.realpath('Code.py')) + '\\SubstrateData\\Double'))

            for i in range(len(files1)):
                files1[i] = files1[i].rstrip(".txt")
                files2[i] = files2[i].rstrip(".txt")
                files3[i] = files3[i].rstrip(".txt")
                ...
                #This can be commented out with an alternet approach
                vars()[files1[i]][0] = vars()[files1[i]][0]
                vars()[files2[i]][0] = vars()[files2[i]][0]
                vars()[files3[i]][0] = vars()[files3[i]][0]
                
                vars()[files1[i]][1] = vars()[files1[i]][1] / 100
                vars()[files2[i]][1] = vars()[files2[i]][1] / 100
                vars()[files3[i]][1] = vars()[files3[i]][1] / 100
                
                # vars()[files1[i]+'T'] = F.DYThorLabs(F.Trim(vars()[files1[i]],xMin,xMax))
                vars()[files1[i]+'T'] = F.Trim(vars()[files1[i]],xMin,xMax)
                vars()[files2[i]+'T'] = F.Trim(vars()[files2[i]],xMin,xMax)
                vars()[files3[i]+'T'] = F.Trim(vars()[files3[i]],xMin,xMax)
                
                if len(vars()[files1[i]][0]) < vars()[files2[i]][0]:
                    xNew,yNew = F.IntValSelector(vars()[files2[i]][0],vars()[files2[i]][1])
                    xNew1,yNew1 = F.IntValSelector(vars()[files3[i]][0],vars()[files3[i]][1])
                    
                    k1 = yNew1 / yNew
                    k2 = vars()[files1[i]+'T'][1] / yNew1                
                    
                else:               
                     k1 = vars()[files3[i]+'T'][1] / vars()[files2[i]+'T'][1]
                     k2 = vars()[files1[i]+'T'][1] / vars()[files3[i]+'T'][1]
    ...
    case 3:
            ...
            path1, dirs1, files1 = next(os.walk(os.path.dirname(os.path.realpath('Code.py')) + '\\SubstrateData'))
            path2, dirs2, files2 = next(os.walk(os.path.dirname(os.path.realpath('Code.py')) + '\\SubstrateData\\Single Resin'))
            path3, dirs3, files3 = next(os.walk(os.path.dirname(os.path.realpath('Code.py')) + '\\SubstrateData\\Double Resin'))
            path4, dirs4, files4 = next(os.walk(os.path.dirname(os.path.realpath('Code.py')) + '\\SubstrateData\\Double'))
            ...
            for i in range(len(files1)):
                ...
                files2[i] = files2[i].rstrip(".txt")
                files3[i] = files3[i].rstrip(".txt")
                files4[i] = files4[i].rstrip(".txt")
                
                vars()[files1[i]] = np.loadtxt(open(path1 + "\\" + files1[i] + ".txt", "rb"), delimiter=",",skiprows = 2).T
                vars()[files2[i]] = np.loadtxt(open(path2 + "\\" + files2[i] + ".txt", "rb"), delimiter=",",skiprows = 2).T
                vars()[files3[i]] = np.loadtxt(open(path3 + "\\" + files3[i] + ".txt", "rb"), delimiter=",",skiprows = 2).T
                vars()[files4[i]] = np.loadtxt(open(path4 + "\\" + files4[i] + ".txt", "rb"), delimiter=",",skiprows = 2).T
                ...
                vars()[files2[i]][1] = vars()[files2[i]][1] / 100
                vars()[files3[i]][1] = vars()[files3[i]][1] / 100
                vars()[files4[i]][1] = vars()[files4[i]][1] / 100

                # vars()[files1[i]+'T'] = F.DYThorLabs(F.Trim(vars()[files1[i]],xMin,xMax))
                vars()[files1[i]+'T'] = F.Trim(vars()[files1[i]],xMin,xMax)
                vars()[files2[i]+'T'] = F.Trim(vars()[files2[i]],xMin,xMax)
                vars()[files3[i]+'T'] = F.Trim(vars()[files3[i]],xMin,xMax)     
                vars()[files4[i]+'T'] = F.Trim(vars()[files4[i]],xMin,xMax)  
                
                if len(vars()[files1[i]][0]) < len(vars()[files2[i]][0]):
                    xNew,yNew = F.IntValSelector(vars()[files2[i]+'T'][0],vars()[files2[i]+'T'][1])
                    xNew1,yNew1 = F.IntValSelector(vars()[files3[i]+'T'][0],vars()[files3[i]+'T'][1])
                    xNew2,yNew2 = F.IntValSelector(vars()[files4[i]+'T'][0],vars()[files4[i]+'T'][1])
                    
                    k1 = yNew1 / yNew
                    k2 = yNew2 / yNew1
                    k3 = vars()[files1[i]+'T'] / yNew2              
                    
                else:               
                     k1 = vars()[files3[i]+'T'][1] / vars()[files2[i]+'T'][1]
                     k2 = vars()[files4[i]+'T'][1] / vars()[files3[i]+'T'][1]
                     k3 = vars()[files1[i]+'T'][1] / vars()[files4[i]+'T'][1]
                ...
                vars()['yP'+files1[i]] = np.interp(xP,vars()[files1[i]+'T'][0],vars()[files1[i]+'T'][1])
                # vars()['yP'+files2[i]] = np.interp(xP,vars()[files2[i]+'T'][0],vars()[files2[i]+'T'][1])
                # vars()['yP'+files3[i]] = np.interp(xP,vars()[files3[i]+'T'][0],vars()[files3[i]+'T'][1]) 
...
for i in range(len(files)):
    ...
    vars()[files[i]+'T'][1] = Multi * vars()[files[i]+'T'][1]
